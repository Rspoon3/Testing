...
public struct Shimmer: ViewModifier {
    ...
    public static let defaultBounceAnimation = Animation.linear(duration: 1.5).delay(0.25).repeatForever(autoreverses: true)

    // A default gradient for the animated mask.
    public static let defaultGradient = Gradient(colors: [
        .white, // translucent
        .black.opacity(0), // opaque
        .white // translucent
        
//        .black.opacity(0), // translucent
//        .black, // opaque
//        .black.opacity(0) // translucent
    ])
