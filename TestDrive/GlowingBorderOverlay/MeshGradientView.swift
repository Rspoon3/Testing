...
/// An animated nine-point ``MeshGradient`` whose interior points drift over time
/// to produce a colorful Siri-style backdrop.
struct MeshGradientView: View {
    ...
    /// Returns a sine wave value mapped into the supplied range.
